# Generated by Powerlevel10k configuration wizard on 2025-10-25 at 14:02 HKT.
...
() {
  ...
  # Enable terminal shell integration (OSC 133 marks) to mitigate prompt reflow issues on resize.
  typeset -g POWERLEVEL9K_TERM_SHELL_INTEGRATION=true

  # VS Code integrated terminal (xterm.js) doesn't honor OSC 133 and reflows on resize.
  # Apply conservative settings there to avoid prompt misplacement artifacts.
...
# --- Non-theming quality-of-life settings migrated from previous config ---
